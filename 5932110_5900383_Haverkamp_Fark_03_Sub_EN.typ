...
The deviation seen between "*$V_(i n)$*", "*actual $V_(i n)$*" and "*final $V_(i n)$*" in @vins happen firstly because 5 V through WaveGen is less than 5 V when directly measured on the board and secondly because "final" $V_(i n)$ is connected to the circuit while "actual" $V_(i n)$ was to be measured stand alone.
